...
menu_acciones.add_command(label="Agregar receta", command=agregar_receta)
menu_acciones.add_command(label="Ver ingredientes", command=ver_ingredientes)
menu_acciones.add_command(label="Eliminar receta", command=eliminar_receta)
menu_acciones.add_separator()
menu_acciones.add_command(label="Salir", command=salir)
...
btn_salir = tk.Button(ventana, text="Salir del programa", command=salir)
btn_salir.pack()
